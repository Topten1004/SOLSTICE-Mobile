...
class _OtpVerificationState extends State<OtpVerification>
  ...
  void initState() {
    ...
    if (widget.countryCode != null) {
      ...
      countryCodeWithoutPlus =
          countryCodeWithoutPlus.replaceAll(new RegExp(r'[^\w\s]+'), '');
    }
  ...
  void onFailure(int code, String message) {
    ...
    Constants.showSnackBarWithMessage(
        "" + message, _scaffoldkey, context, Colors.red[700]);
  }
  ...
  void onSuccess(Object data, int code) {
    ...
    if (code == UrlConstant.loginCode || code == UrlConstant.registerCode) {
      ...
      if (userData != null) {
        ...
        SharedPref.saveStringInPrefs(
            Constants.USER_ID, userData.data.id.toString());
        ...
        SharedPref.saveStringInPrefs(
            Constants.LOGIN_RESPONSE, jsonEncode(userData.data));
        SharedPref.saveBooleanInPrefs(Constants.LOGINSTATUS, true);
      ...
      final CommonMessageModel commonMessageModel =
          CommonMessageModel.fromJson(data);
      Constants.showSnackBarWithMessage("" + commonMessageModel.message,
  ...
  Future<void> _submitPhoneNumber() async {
    ...
    String phoneNumber =
        "+" + countryCodeWithoutPlus + " " + widget.phoneNumber;
    setState(() {
      _showLoading = true;
    });

...
class SaveToRoutine extends StatefulWidget {
  @override
  _SaveToRoutineState createState() => _SaveToRoutineState();
}

class _SaveToRoutineState extends State<SaveToRoutine> {
  ...
  void getRoutines() {
    ...
    FirebaseFirestore.instance
      ...
      value.docs.forEach((element) {
        ...
        stitchRoutineModel.isPublic = element.data()["is_public"];

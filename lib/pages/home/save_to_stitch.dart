...
class SaveToStitch extends StatefulWidget {
  String feedId;
  SaveToStitch({this.feedId});
  @override
  _SaveToStitchState createState() => _SaveToStitchState();
}

class _SaveToStitchState extends State<SaveToStitch> {
  ...
  void getStiitches() {
    ...
    FirebaseFirestore.instance
      ...
      value.docs.forEach((element) {
        StitchRoutineModel stitchRoutineModel = new StitchRoutineModel.fromJson(
            element.data(),
            stitchId: element.id);
        if (stitchRoutineModel.feedIds.contains(widget.feedId)) {
          stitchRoutineModel.isSelected = true;
        }
                              ...
                              setState(() {
                                ...
                                if (stitchId.isEmpty) {
                                  return Constants().errorToast(context,
                                      "Please select at least on stitch");
                                }

                                Navigator.of(context).pop({
                                  "stitch_id": stitchId,
                                  "stitch_title": stitchTitle
                                });
                              });
                            },
                            child: Text(
  ...
  void updateDataToFb(String collectionName, String imageURl) {
    var stitchMap = {

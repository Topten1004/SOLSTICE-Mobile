...
import 'package:solstice/pages/uploads/PodCastTrailer.dart';
...
class PodCastAdjust extends StatefulWidget {
  const PodCastAdjust({Key key}):super(key:key) ;

  _PodCastAdjustState createState() => _PodCastAdjustState() ;
}

class _PodCastAdjustState extends State<PodCastAdjust> {
          ...
          child: Column(
            children: [
              ...
              Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => PodCastTrailer())) ;
                    },
                    child : Container(
